...
export const glossary = [
  ...
  { term: 'Supported IDEs', definition: 'VS Code, IntelliJ IDEA, PyCharm, WebStorm, GoLand, Rider, and other JetBrains IDEs — plus Eclipse and Xcode. Any IDE with the GitHub Copilot plugin and agent mode support.' },
  { term: 'Copilot Chat', definition: 'The chat panel inside your IDE where you type messages to the Coordinator agent. Available in VS Code, JetBrains IDEs, Eclipse, and Xcode.' },
